...
export default function StateRollupPage() {
  const rows = locationRollup('state');
  ...
  return (
    <div className="px-8 md:px-12 pt-10 pb-20 max-w-[1600px] mx-auto space-y-12 min-h-full flex flex-col bg-background">
      <div className="flex items-center justify-between pb-6 border-b border-border/40">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-foreground">State Rollup</h1>
          <p className="text-sm text-muted-foreground mt-1">Statewide post-award position.</p>
        </div>
      </div>
